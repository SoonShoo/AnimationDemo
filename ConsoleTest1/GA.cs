		...
		public void Go()
		{
            ...
            var result = new string(
                Enumerable.Repeat(chars, 8)
                          ...
                          .ToArray());
            System.IO.StreamWriter file = new System.IO.StreamWriter("d:\\output" + result + ".txt");
			...
			for (int i = 0; i < m_generationSize; i++)
			{
                ...
                if (i % 20 == 0) {
                    System.IO.StreamWriter file2 = new System.IO.StreamWriter("d:\\noutputNEU.txt");
                    double[] weights1;
                    double fitness1;
                    GetBest(out weights1, out fitness1);
                    file2.WriteLine(String.Join(",", weights1));
                    file2.Close();
                }
            }
